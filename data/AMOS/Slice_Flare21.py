...
for split in splits:
    if(split == 'train'):
        ct_path = './synapse/synapse_3d/imagesTr' # set your path to your trainset directory
        seg_path = './synapse/synapse_3d/labelsTr'
        save_path = './synapse/synapse_2d/train_npz_new/'
    elif (split == 'val'):
        ct_path = './synapse/synapse_3d/imagesVal'  # set your path to your valset directory
        seg_path = './synapse/synapse_3d/labelsVal'
        save_path = './synapse/synapse_2d/test_vol_new/'
    else:
        ct_path = './root_dir/imagesTs' # set your path to your testset directory
        seg_path = './root_dir/labelsTS'
        save_path = './Flare21_272/test_h5_new/'
    ...
    for ct_file in os.listdir(ct_path):
        ...
        seg = nib.load(os.path.join(seg_path, ct_file.replace('_0000','').replace('img', 'label')))
