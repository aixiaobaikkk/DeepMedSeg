...
for split in splits:
    if(split == 'train'):
        ct_path = './synapse_3d/imagesTr' # set your path to your trainset directory
        seg_path = './synapse_3d/labelsTr'
        save_path = './synapse_2d/train_npz_new/'
    elif (split == 'test'):
        ct_path = './synapse_3d/imagesVal'  # set your path to your valset directory
        seg_path = './synapse_3d/labelsVal'
        save_path = './synapse_2d/test_vol_new/'
