...
class myDataset(data.Dataset):
    def __init__(self, fold, split, size=512, aug=False, polar=False):
        ...
        indexes = os.listdir(
            '../data/skin_lesion/isic2018_jpg_512_smooth/Image')
        ...
        root_dir = '../data/skin_lesion/isic2018_jpg_512_smooth'
        if self.polar:
            if split == 'train':
                self.image_paths = [
