...
class myDataset(data.Dataset):
    def __init__(self, split, size=512, aug=False, polar=False):
        ...
        root_dir = '../data/skin_lesion/isic2016_jpg_512_smooth'
        ...
        if split == 'train':
            ...
            self.label_paths = [
                f'{root_dir}/Train/Label/{_id[:-4]}.jpg'
                for _id in indexes
            ]
            self.point_paths = [
                f'{root_dir}/Train/Point/{_id[:-4]}.jpg'
                for _id in indexes
            ]
            ...
            self.label_paths = [
                f'{root_dir}/Validation/Label/{_id[:-4]}.jpg'
                for _id in indexes
            ]
        else:
            ...
            self.label_paths = [
                f'{root_dir}/Test/Label/{_id[:-4]}_lesion.bmp'
                for _id in indexes
            ]
