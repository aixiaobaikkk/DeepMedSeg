...
from other_networks.CASCADE.pvtv2 import pvt_v2_b2
from other_networks.CASCADE.decoder import CASCADE
from other_networks.CASCADE.cnn_vit_backbone import Transformer, SegmentationHead
...
class PVT_CASCADE(nn.Module):
    def __init__(self, n_class=9):
        ...
        path1 = './other_networks/CASCADE/pvt_v2_b2.pth'
        path2 = 'pvt_v2_b2.pth'
        try:
