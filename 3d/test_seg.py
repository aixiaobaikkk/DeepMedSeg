...
parser.add_argument('--root', type=str, default='/amax/home/Admin/work/paper_code/LUCF-Net-main/data/Subtask2_272_69_20/', help='Root folder of all your images and labels')
parser.add_argument('--output', type=str, default='output_unetr',  help='Output folder for both tensorboard and the best model')
...
parser.add_argument('--network', type=str, default='UNETR', help='Network models: {TransBTS, nnFormer, UNETR, SwinUNETR, 3DUXNET}')
parser.add_argument('--trained_weights', default='/amax/home/Admin/work/paper_code/LUCF-Net-main/3DUX-Net-main/output_UNETR/best_metric_model.pth', help='Path of pretrained/fine-tuned weights')
...
parser.add_argument('--gpu', type=str, default='2', help='your GPU number')
...
with torch.no_grad():
    ...
    print("single sanple time: ", total_time / 20)
    print("FPS: ", 1 / total_time *20 )
    print("===============================")
